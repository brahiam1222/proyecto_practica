...
function insertaFila() {
    ...
    cell1.innerHTML = "<input type='text' class='form-control' id='cod' placeholder='' value="+conta+" disabled>";
    cell2.innerHTML = "<input type='text' class='form-control' id='cod' placeholder='' value='' required>";
    cell3.innerHTML = "<input type='text' class='form-control' id='sm1' placeholder='' value'' disabled>";
    cell4.innerHTML = "<input type='text' class='form-control' id='sm2' placeholder='' value'' required=''>";
    cell5.innerHTML = "<input type='text' class='form-control' id='sm3' placeholder='' value'' required=''>";
